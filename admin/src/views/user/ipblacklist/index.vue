<template>
  <div class="ipblacklist-lists">
    <el-card class="!border-none" shadow="never">
      <div>
        <el-button v-perms="['user:ipblacklist:add']" type="primary" @click="handleAdd">
          <template #icon>
...
<script lang="ts" setup name="ipblacklist">
import {ipblacklistDelete, ipblacklistLists} from '@/api/user/ipblacklist'
...
const handleDelete = async (id: string) => {
  ...
  await ipblacklistDelete({ids: [id]})
