<template>
  <div class="ipwhitelist-lists">
    <el-card class="!border-none" shadow="never">
      <div>
        <el-button v-perms="['user:ipwhitelist:add']" type="primary" @click="handleAdd">
          <template #icon>
...
import {ipwhitelistDelete, ipwhitelistLists} from '@/api/user/ipwhitelist'
